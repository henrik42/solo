...
return (new CustomEvent(event_name,(function (){var obj26726 = {"detail":data};
return obj26726;
})()));
} else {
...
var f = (function (){var pred__26733 = cljs.core._EQ_;
var expr__26734 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26733.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26734))){
return ((function (pred__26733,expr__26734){
return (function (p1__26727_SHARP_){
return console.warn(p1__26727_SHARP_);
});
;})(pred__26733,expr__26734))
} else {
if(cljs.core.truth_(pred__26733.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26734))){
return ((function (pred__26733,expr__26734){
return (function (p1__26728_SHARP_){
return console.debug(p1__26728_SHARP_);
});
;})(pred__26733,expr__26734))
} else {
if(cljs.core.truth_(pred__26733.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26734))){
return ((function (pred__26733,expr__26734){
return (function (p1__26729_SHARP_){
return console.error(p1__26729_SHARP_);
});
;})(pred__26733,expr__26734))
} else {
return ((function (pred__26733,expr__26734){
return (function (p1__26730_SHARP_){
return console.log(p1__26730_SHARP_);
});
;})(pred__26733,expr__26734))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26737){
...
var eval_fn = cljs.core.get.call(null,map__26738__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26740_SHARP_);
});})(new_def))
);
...
return (function (p__26741){
var vec__26742 = p__26741;
var ky = cljs.core.nth.call(null,vec__26742,(0),null);
var v = cljs.core.nth.call(null,vec__26742,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1530166198234
