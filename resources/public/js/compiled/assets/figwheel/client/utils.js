...
return (new CustomEvent(event_name,(function (){var obj26161 = {"detail":data};
return obj26161;
})()));
} else {
...
var f = (function (){var pred__26168 = cljs.core._EQ_;
var expr__26169 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26168.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26169))){
return ((function (pred__26168,expr__26169){
return (function (p1__26162_SHARP_){
return console.warn(p1__26162_SHARP_);
});
;})(pred__26168,expr__26169))
} else {
if(cljs.core.truth_(pred__26168.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26169))){
return ((function (pred__26168,expr__26169){
return (function (p1__26163_SHARP_){
return console.debug(p1__26163_SHARP_);
});
;})(pred__26168,expr__26169))
} else {
if(cljs.core.truth_(pred__26168.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26169))){
return ((function (pred__26168,expr__26169){
...
return console.log(p1__26165_SHARP_);
});
;})(pred__26168,expr__26169))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26172){
...
var eval_fn = cljs.core.get.call(null,map__26173__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26175_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__26177,(0),null);
var v = cljs.core.nth.call(null,vec__26177,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1534453579854
