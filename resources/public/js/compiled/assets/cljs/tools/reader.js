...
var G__4849 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4849;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4850 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4850,ch);
...
if(("\\" === ch__$1)){
var ch_4851__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4851__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4851__$2);
} else {
}

var G__4852 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4852;
continue;
}
}
...
var vec__4860 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4860,(0),null);
var start_column = cljs.core.nth.call(null,vec__4860,(1),null);
...
var G__4863 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4863;
continue;
}
}
...
var _STAR_read_delim_STAR_4864 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_4864;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4865 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4865,(0),null);
var start_column = cljs.core.nth.call(null,vec__4865,(1),null);
...
var vec__4868 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4868,(0),null);
var end_column = cljs.core.nth.call(null,vec__4868,(1),null);
...
var vec__4871 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4871,(0),null);
var start_column = cljs.core.nth.call(null,vec__4871,(1),null);
...
var vec__4874 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4874,(0),null);
var end_column = cljs.core.nth.call(null,vec__4874,(1),null);
...
var vec__4877 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4877,(0),null);
var start_column = cljs.core.nth.call(null,vec__4877,(1),null);
...
var vec__4880 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4880,(0),null);
var end_column = cljs.core.nth.call(null,vec__4880,(1),null);
...
var sb = (function (){var G__4883 = (new goog.string.StringBuffer());
G__4883.append(initch);
...
var G__4885 = (function (){var G__4884 = sb;
G__4884.append(ch);

return G__4884;
})();
var G__4886 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4885;
ch = G__4886;
continue;
}
...
switch (G__4889) {
case "\\":
var G__4893 = (function (){var G__4890 = sb;
G__4890.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4890;
})();
var G__4894 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4893;
ch = G__4894;
continue;
...
break;
default:
var G__4895 = (function (){var G__4891 = sb;
G__4891.append(ch);

return G__4891;
})();
var G__4896 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4895;
ch = G__4896;
continue;
...
var vec__4897 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4897,(0),null);
var end_column = cljs.core.nth.call(null,vec__4897,(1),null);
...
var vec__4900 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4900,(0),null);
var column = cljs.core.nth.call(null,vec__4900,(1),null);
...
var vec__4905 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4905,(0),null);
var column = cljs.core.nth.call(null,vec__4905,(1),null);
...
var line = cljs.core.nth.call(null,vec__4910,(0),null);
var column = cljs.core.nth.call(null,vec__4910,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4915 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4915,(0),null);
var start_column = cljs.core.nth.call(null,vec__4915,(1),null);
...
var vec__4918 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4918,(0),null);
var end_column = cljs.core.nth.call(null,vec__4918,(1),null);
...
var G__4921 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4921,true,null,opts,pending_forms);
...
var G__4922 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4922)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4922)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4922)){
...
var _STAR_suppress_read_STAR_4923 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4923;
}});
...
var G__4924 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4924,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4924,rdr,first_line);
...
var G__4928 = matched;
var G__4929 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4928;
finished = G__4929;
continue;
} else {
...
var _STAR_suppress_read_STAR_4930 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_4930;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env4931 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4932 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4932,"(");
...
var G__4933 = (i + (1));
var G__4934 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env4931;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4935 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4935);
...
var G__4936 = cljs.core.next.call(null,s__$1);
var G__4937 = ret;
s__$1 = G__4936;
r = G__4937;
continue;
...
var G__4938 = cljs.core.next.call(null,s);
var G__4939 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4938;
key_vals = G__4939;
continue;
} else {
...
var gensym_env4943 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env4943;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4944 = token;
var G__4944__$1 = (((G__4944 == null))?null:cljs.core.subs.call(null,G__4944,(1)));
var G__4944__$2 = (((G__4944__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4944__$1));
var G__4944__$3 = (((G__4944__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4944__$2));
var G__4944__$4 = (((G__4944__$3 == null))?null:cljs.core.symbol.call(null,G__4944__$3));
if((G__4944__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4944__$4);
}
})():(function (){var G__4945 = token;
var G__4945__$1 = (((G__4945 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4945));
if((G__4945__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4945__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
}catch (e4952){if((e4952 instanceof Error)){
var e = e4952;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4956,reader){
var map__4957 = p__4956;
var map__4957__$1 = ((((!((map__4957 == null)))?(((((map__4957.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4957.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__4957):map__4957);
var opts = map__4957__$1;
var eof = cljs.core.get.call(null,map__4957__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___4965 = arguments.length;
var i__4500__auto___4966 = (0);
while(true){
if((i__4500__auto___4966 < len__4499__auto___4965)){
args__4502__auto__.push((arguments[i__4500__auto___4966]));

var G__4967 = (i__4500__auto___4966 + (1));
i__4500__auto___4966 = G__4967;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq4963){
var G__4964 = cljs.core.first.call(null,seq4963);
var seq4963__$1 = cljs.core.next.call(null,seq4963);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4964,seq4963__$1);
});


//# sourceMappingURL=reader.js.map?rel=1529003144475
